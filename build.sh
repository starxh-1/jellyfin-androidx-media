...
export ANDROID_NDK_PATH=$ANDROID_HOME/ndk/29.0.13599879
...
export ENABLED_DECODERS=(mpeg1video mpeg2video
    flv h263 vp6 vp6f h264
    msmpeg4v1 msmpeg4v2 msmpeg4v3 mpeg4
    wmv1 wmv2 wmv3 vc1)
